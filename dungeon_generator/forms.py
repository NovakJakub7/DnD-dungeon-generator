...
class DungeonForm(FlaskForm):
    ...
    bsp_min_partition_height = IntegerField("Minimal room heigth (cells)", validators=[Optional(), NumberRange(2, 50)], render_kw={"placeholder": "5"})
    number_of_floors = IntegerField("Number of Floors", validators=[Optional(), NumberRange(1, 20)], render_kw={"placeholder": "3"})
    max_treasure_value = IntegerField("Maximal Treasure Value (gp)", validators=[Optional(), NumberRange(min=10)], render_kw={"placeholder": "500"})
